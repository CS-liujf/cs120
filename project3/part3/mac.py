...
class MAC(Process):
    ...
    def run(self):
        ...
        self.tw = TWINDOW(25, 64, self.Network_Link_queue, self.MAC_Tx_queue,
                          self.Tx_message_queue, self.Rx_ACK_queue,
                          self.barrier)
        self.rw = RWINDOW(25, 64, self.Link_Network_queue, self.MAC_Tx_queue,
...
class Rx(Process):
    ...
    def input_process(self, input_queue: standard_queue.Queue,
                      Rx_ACK_queue: Queue, Rx_MAC_queue: Queue):
        while True:
